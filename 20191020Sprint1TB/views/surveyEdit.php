...
<div id='main'>
				<div id='pageDescription'>
					...
					<input type="hidden" name="insertTime" value="<?php echo date('Y-m-d H:i:s'); ?>" readonly="readonly">
						...
						<fieldset>
							<legend><b>Email Address</b></legend>
								<div id = 'input-content'>
									...
									<input type='text' name='email' id='txtEmail' tabindex='1' size='50' value='<?php echo $email; ?>' placeholder='Please enter a valid email address'>&nbsp;&nbsp;&nbsp;
					...
					<br>
						...
						<fieldset>
							<legend><b><span class='required'>* </span>CNMT-310 Expected Grade: </b>(select one)</legend>
								...
								<?php $grade = (isset($grade))?$grade:""; ?>
									<input type='radio' name='grade' id='rdoGradeA' tabindex='8' value='A'
						...
						<div class='buttons'>
							<button type='submit' class='buttonStyle' id='btnSubmit' name='btnSubmit'><img src='images/user-save.png' alt='Submit'  tabindex='29' onclick = validateForm;>&nbsp;Submit</button>
