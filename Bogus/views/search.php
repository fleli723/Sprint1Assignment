...
<div id='main'>
			<div id='pageDescription'>
				...
				<span class='required'>* </span>Indicates a required entry
					<form class='formStyle' name="frmSearch" id="search" method ='GET' action='searchResults.php'>
						<fieldset>
							<legend><b>Search String</b></legend>
								<div id = 'input-content'>
									...
									<input type='text' name='search' id='txtsearch' tabindex='1' size='50' value='<?php echo $search; ?>' required placeholder='Please enter search criteria'>
